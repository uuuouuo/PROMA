  ...
  public void mailSend(List<String> inviteMails, String projectNo, String nickname) {
    ...
    try {
      ...
      for(String address : inviteMails){
        ...
        htmlContent += "<div style=\"color:#333333\"><div style=\"color:#333333\"><b>"+nickname+"</b>님이 <a href=\"localhost:3000/project/"+projectNo+"\">일지</a> 페이지에 초대했습니다.</div><div style=\"color:#333333;margin-top:16px\"><a href=\"localhost:3000/project/" +projectNo+"\"><b>여기를 클릭하여 확인하세요.</b></a></div></div>";
